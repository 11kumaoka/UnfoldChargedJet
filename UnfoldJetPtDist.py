...
outputDir='/Users/tkumaoka/ALICE/cernbox/SWAN_projects/outputFiles/LHC18qr/pass3/Ch/Unfolded/'\
    + 'R0'+str(JetR)+'/'
# outputDir = '/Users/tkumaoka/ALICE/cernbox/SWAN_projects/outputFiles/LHC18qr/pass3/Ch/Unfolded/UFTest/'
...
def changePrior(hRMOrig, hMeasuredJetSpectPerBinOrig, ptBinArrayDict, centBin):
    ...
    for ptTruBin in range(1,nYBins+1):
        ...
        if(scaleVal <= 0.): 
            ...
            scaleLVal = fRatioFitP0*temLGenPtVal*temLGenPtVal + fRatioFitP1*temLGenPtVal +fRatioFitP2
            scaleHVal = fRatioFitP0*temHGenPtVal*temHGenPtVal + fRatioFitP1*temHGenPtVal +fRatioFitP2
